...
AutoTools.commandOnClick = function (selector, command, prefix) {
  document.querySelector(selector).onclick = e =>
    AutoTools.sendCommand(command, prefix);
};
/**
 ...
 */
AutoTools.increaseBrightnessRule = function (
  rule,
  propertyName,
  percent,
  darken
 ...
 */
AutoTools.objectToElements = function (
  rootElementsId,
  rootElementClass,
  input,
  itemTransformer
 ...
 * @param {Function} [itemTransformer] - Optional transformer that will be called for each element on the page
 */
AutoTools.variablesToElements = function (
  webscreenVariables,
  rootElementsId,
  rootElementClass,
  itemTransformer
 ...
 */
AutoTools.setLayout = (width, height, x, y, gravity) =>
  AutoToolsAndroid.setLayout(width, height, x, y, gravity);
 ...
 * Will get the Tasker input that was used to show the screen
 */
AutoTools.getTextInput = (title, message, initialText) =>
  AutoToolsAndroid.getTextInput(title, message, initialText);
 ...
 * @param {boolean} enable - select if you want to enable or disable it
 */
AutoTools.setflingOnNegativeX = enable =>
  AutoToolsAndroid.setflingOnNegativeX(enable);

/**
 * Enable or disable fling to dismiss on positive X
 * @param {boolean} enable - select if you want to enable or disable it
 */
AutoTools.setflingOnPositiveX = enable =>
  AutoToolsAndroid.setflingOnPositiveX(enable);

/**
 * Enable or disable fling to dismiss on negative Y
 * @param {boolean} enable - select if you want to enable or disable it
 */
AutoTools.setflingOnNegativeY = enable =>
  AutoToolsAndroid.setflingOnNegativeY(enable);

/**
 * Enable or disable fling to dismiss on positive Y
 * @param {boolean} enable - select if you want to enable or disable it
 */
AutoTools.setflingOnPositiveY = enable =>
  AutoToolsAndroid.setflingOnPositiveY(enable);

/**
 * Check if fling to dismiss is enabled for left
 * @param {string} fling - current fling to dismiss value
 */
AutoTools.checkFlingLeft = fling =>
  fling == AutoTools.FLING_TO_DISMISS_LEFT ||
  fling == AutoTools.FLING_TO_DISMISS_LEFT_AND_RIGHT ||
  fling == AutoTools.FLING_TO_DISMISS_ALL;
/**
 * Check if fling to dismiss is enabled for right
 * @param {string} fling - current fling to dismiss value
 */
AutoTools.checkFlingRight = fling =>
  fling == AutoTools.FLING_TO_DISMISS_RIGHT ||
  fling == AutoTools.FLING_TO_DISMISS_LEFT_AND_RIGHT ||
  fling == AutoTools.FLING_TO_DISMISS_ALL;
/**
 ...
 * @param {string} fling - current fling to dismiss value
 */
AutoTools.checkFlingUp = fling =>
  fling == AutoTools.FLING_TO_DISMISS_UP ||
  fling == AutoTools.FLING_TO_DISMISS_UP_AND_DOWN ||
  fling == AutoTools.FLING_TO_DISMISS_ALL;
/**
 * Check if fling to dismiss is enabled for down
 * @param {string} fling - current fling to dismiss value
 */
AutoTools.checkFlingDown = fling =>
  fling == AutoTools.FLING_TO_DISMISS_DOWN ||
  fling == AutoTools.FLING_TO_DISMISS_UP_AND_DOWN ||
  fling == AutoTools.FLING_TO_DISMISS_ALL;
 ...
 */
AutoTools.onclickandlongclick = function (
  element,
  callbackClick,
  callbackLongClick,
  longClickTime
